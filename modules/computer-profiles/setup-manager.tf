resource "jamfpro_macos_configuration_profile_plist" "setup_manager" {
  name                = "Setup Manager (Managed by Terraform)"
  description         = ""
  level               = "System"
  distribution_method = "Install Automatically"
  redeploy_on_update  = "All"
  payloads            = file("${path.module}/support-files/setup-manager.mobileconfig")
